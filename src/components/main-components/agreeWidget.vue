...
.agree-widget {
  @apply w-full grid md:grid-flow-col gap-3 md:gap-0 justify-center items-center p-4 fixed text-main bg-white z-20 bottom-0 text-center border-main border-t-2 border-solid;
