<template>
  <div class="products-categories">
    <div class="products-categories__row">
      <div class="products-categories__category">
        <div class="products-categories__info">
          ...
          ><span class="products-categories__name"></span>
        </div>
      </div>
    </div>
  </div>
...
.products-categories {
  @apply grid grid-flow-col justify-items-center items-center;
}
</style>
